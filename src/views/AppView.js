        ...
        case "CUT_FIRST":
            ...
            if(fullText.length > 0 ){
                ...
                if(this.state.resultText == ""){
                    newFullText = fullText.substring(1);
                    if(newFullText == ""){
                        newFullText = "0";
                    }
                ...
                <div className="calculatorArea">
                  <div className="row">
                    ...
                    <div className="col-md-12 calculator-body-part">
                      <div className="row justify-content-center">
                          <Button isIcon={'fa fa-undo'} buttonClass="top-button" onClick={this.undoClick}/>
                          <Button buttonClass="top-button" isIcon={'fa fa-arrow-left'}  onClick={() => this.functionalButtonClick("CUT_FIRST")} />
                          <Button buttonClass="top-button  text-bold" onClick={() => this.functionalButtonClick("AC")} textValue="AC"/>

                      </div>

                      <div className="row justify-content-center mt-2">
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(7)} textValue="7"/>
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(8)} textValue="8"/>
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(9)} textValue="9"/>
                          <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.operationClick('/')} textValue="÷"/>
                          <Button buttonClass="btn-digit-operation btn-operation text-bold" textValue="√"  onClick={() => this.functionalButtonClick("SQ_ROOT")} />
                      </div>

                      <div className="row justify-content-center mt-2">
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(4)} textValue="4"/>
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(5)} textValue="5"/>
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(6)} textValue="6"/>
                          <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.operationClick('*')} textValue="×"/>
                          <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.functionalButtonClick('x^2')} textValue="x^2"/>
                      </div>

                      <div className="row justify-content-center mt-2">
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(1)} textValue="1"/>
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(2)} textValue="2"/>
                          <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(3)} textValue="3"/>
                          <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.operationClick('-')} textValue="-"/>
                          <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.functionalButtonClick('1/x')} textValue="1/x"/>
                      </div>

                      <div className="row justify-content-center mt-2">
                        <Button buttonClass="btn-digit-operation btn-digit text-bold" onClick={() => this.digitClick(0)} textValue="0"/>
                        <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.dotClick()} textValue="."/>
                        <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.functionalButtonClick('+-')} textValue="±"/>
                        <Button buttonClass="btn-digit-operation btn-operation text-bold" onClick={() => this.operationClick('+')} textValue="+"/>
                        <Button buttonClass="btn-digit-operation btn-equal text-bold" onClick={() => this.equalClick()} textValue="="/>
                      </div>
